...
PHASE_572_WALKTHROUGH_PATH="${ILC_PHASE_574_PHASE_572_WALKTHROUGH_PATH:-docs/phases/phase_0572_g8_three_machine_smoke_harness_walkthrough.md}"
...
elif 'HTTP_GOSSIP_TRANSPORT_RUNTIME_VERSION = "http_gossip_transport_runtime_1572.v0.1"' not in transport_text:
