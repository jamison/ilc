...
INSTALLER_VERSION="GAP-PACKAGE-0423-00b"
RC_WHEEL_URL="https://files.pythonhosted.org/packages/86/7d/f0ac4770359bf6a163d62770d63d2c4649988c9030ab2f4802c9c9bf32ce/ilc_core-0.4.23-py3-none-any.whl"
RC_WHEEL_SHA256="446b6e61c5474d20e0fd3db83afd4ce985ba5d94b3772ac9a05ee414503d9c6d"
RC_WHEEL_SIZE="1500481"
RC_MIN_PYTHON_MINOR="10"
RC_RELEASE_ID="ilc-core-0.4.23"
RC_WHEEL_ARTIFACT_ID="ilc-artifact:ilc-core-python-wheel-0423@phase-1628"
RC_SDIST_ARTIFACT_ID="ilc-artifact:ilc-core-python-sdist-0423@phase-1628"
RC_SDIST_SHA256="1933b5d1e1ebfd0b1e54944a60044b7a0f1deb768731f2ad329b5b331bafab5e"
RC_SDIST_SIZE="1225833"
DEFAULT_RC_RELEASE_ENVELOPE_REF="https://raw.githubusercontent.com/jamison/ilc/main/docs/specs/ilc_core_0423_release_envelopes_GAP_PACKAGE_0423_00b_v0.1.json"
...
CONSENSUS_BIN_URL="https://github.com/jamison/ilc/releases/download/v0.4.23/ilc-consensus-linux-x86_64-v0.4.23.tar.gz"
...
if envelope_set.get("schema_version") != SCHEMA_VERSION or envelope_set.get("version") != "0.4.23":
...
if [[ "${OS_NAME}" == "Linux" && ( "${ARCH_NAME}" == "x86_64" || "${ARCH_NAME}" == "amd64" ) ]]; then
  ...
  CONSENSUS_TARBALL="${TMP_DIR}/ilc-consensus-linux-x86_64-v0.4.23.tar.gz"
