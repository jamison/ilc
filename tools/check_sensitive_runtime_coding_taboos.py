...
UNTRUSTED_PAYLOAD_BOUND_CONTRACTS = {
    ...
    "ilc_core/sidecars/registry_manifest.py": (
        ...
        "_MAX_PAYLOAD_NODES",
        "_MAX_CANONICAL_JSON_BYTES",
        "sidecar_registry_payload_cycle_forbidden_phase_1307",
        "sidecar_registry_payload_float_forbidden_phase_1307",
        "sidecar_registry_payload_key_invalid_phase_1307",
        "sidecar_registry_payload_int_invalid_phase_1307",
