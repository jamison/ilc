...
from .candidate_validator_record import (
    CANDIDATE_VALIDATOR_RECORD_KIND,
    CANDIDATE_VALIDATOR_RECORD_SCHEMA_VERSION,
    CDL_107_REF as CDL_107_CANDIDATE_REF,
    DEFAULT_VALIDATOR_MODE,
    REQUIRED_NON_CLAIMS as CANDIDATE_VALIDATOR_REQUIRED_NON_CLAIMS,
