...
_SCHEMA_PATH = Path(__file__).parent / "schemas" / "ilc_receipt_schema_v0.1.json"
...
def _map_error(error: Any) -> str:
    ...
    if error.validator == "required":
        # jsonschema default message: "'field' is a required property"
...
def validate_receipt_record(path_or_obj: Union[str, Path, Dict[str, Any]]) -> Dict[str, Any]:
    """
    Validate a receipt record.
    """
    errors: List[str] = []
    warnings: List[str] = []
