...
*Genesis Agent · 2026-09-01 · Draft v0.3 — not for circulation*
...
AI substitution — reverse direction:
  ...
  Three critical differences from the original Lewis mechanism:

  D-1: No biological subsistence floor.
       w → 0 exactly, not w_sub > 0. The floor descends continuously
       as α rises; there is no biological or customary minimum.

  D-2: No absorption mechanism.
       The modern sector (AI-capital) substitutes for cognitive labor;
       it does not absorb it. Surplus cognitive labor is not hired
       into the modern sector — it is displaced from it.

  D-3: No turning point.
       α is not bounded by capital accumulation; it rises with AI
       capability, potentially without limit. There is no α at which
       the AI-capital sector exhausts its substitution potential and
       the wage-productivity link is restored.
