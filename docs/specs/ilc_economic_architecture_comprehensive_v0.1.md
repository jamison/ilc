...
**7.3.2** Design the treasury as a P_e stabilization fund. Absorb excess ILC when fees are high, release ILC when fees are low. Counter-cyclical reserve management, protocol-governed.
