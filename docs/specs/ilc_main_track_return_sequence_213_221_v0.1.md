...
| 218 | `integration` | Implement Genesis accrual governor simulation and cap-trajectory checks aligned to constitutional economics. | Phase 217 freshness gate lock. | Governor simulation tests pass and policy checks are deterministic. |
