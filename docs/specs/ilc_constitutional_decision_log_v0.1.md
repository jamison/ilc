...
| CDL-060 | CDL-036 / CDL-039 | Gossip centrality extension for bounded `centrality_delta` propagation under opaque-channel topology privacy constraints | open | retain ADR-0023 gossip extension as unratified guidance, centrality_delta gossip message type with CDL-039-compliant opaque channel and bounded fanout, centrality_delta with dedicated gossip channel | centrality_delta gossip with opaque channel, bounded fanout, and single-hop scope | docs/specs/ilc_phase_535_544_sequence_lock_v0.1.md, docs/specs/ilc_cdl_060_gossip_centrality_extension_scoping_536_v0.1.md, docs/specs/ilc_sim_centrality_02_gossip_propagation_calibration_538_v0.1.md, docs/specs/ilc_cdl_060_gossip_centrality_extension_opening_stub_539_v0.1.md |
