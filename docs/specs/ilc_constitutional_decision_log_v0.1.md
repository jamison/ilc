...
| CDL-065 | Phase-659 / Phase-660 / Phase-661 / ADR-0028 / Phase-611 | Coupling invariants governance lock and CDL-062 opening admissibility split for keeping protocol truth and public legitimacy upstream of later backend choice | open | leave row-6 coupling as planning intuition, open a narrow governance-lock vehicle with admissibility split, reopen CDL-062 directly without row-6 lock | open a narrow governance-lock vehicle with admissibility split | docs/specs/ilc_phase_659_664_sequence_lock_v0.1.md, docs/specs/ilc_coupling_surface_inventory_and_invariant_matrix_660_v0.1.md, docs/specs/ilc_coupling_counterexample_sweep_661_v0.1.md, docs/specs/ilc_cdl_065_coupling_invariants_governance_lock_opening_662_v0.1.md, docs/specs/ilc_cdl_062_opening_admissibility_matrix_662_v0.1.md | opened_phase: 662 | opened_date: 2026-04-14 |
