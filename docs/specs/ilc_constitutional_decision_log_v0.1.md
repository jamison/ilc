...
| CDL-055 | Validator roadmap 479 / CDL-046 / SIM-010 | Validator Staking and Liveness Enforcement for validator participation stake, liveness penalties, and equivocation slash boundaries | open | leave validator staking unopened indefinitely, amend CDL-046 with validator-participation stake and liveness penalties, overload timed_out orphan policy into validator participation | amend CDL-046 with validator participation stake, partial liveness slash, full equivocation slash, and re-admission boundary | Phase 485 sequence lock, docs/specs/ilc_sim_010_validator_incentive_economics_synthesis_487_v0.1.md, docs/specs/ilc_cdl_054_validator_economic_incentive_framework_ratification_evidence_491_v0.1.md, docs/specs/ilc_cdl_055_validator_staking_and_liveness_enforcement_opening_stub_492_v0.1.md | ratified_phase: TBD | ratified_date: TBD | evidence_document: TBD |
