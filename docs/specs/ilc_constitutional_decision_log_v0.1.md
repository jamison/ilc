...
| CDL-040 | ADR-0014 / CDL-034 / CDL-039 | Admission control policy and identity-envelope semantics | open | identity-envelope extension of authored payload, fourth-envelope plus CDL-034 companion amendment | identity-envelope extension of authored payload (proposed) | ADR-0014 anchor, admission-control scope boundary clause, CDL-039 dependency clause |
| CDL-041 | SIM-004 / CDL-V3 / CDL-039 | Shard lifecycle operations for creation, merge, and split under partition and privacy constraints | open | merge-first lifecycle with highest_ecu_wins reconciliation, split-first elastic lifecycle with delayed merge reconciliation | merge-first lifecycle with highest_ecu_wins reconciliation (proposed) | SIM-004 reconciliation anchor, CDL-V3 diversity dependency clause, CDL-039 non-inferrability clause, CDL-042 defer note |
