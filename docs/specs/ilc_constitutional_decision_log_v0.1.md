...
| CDL-066 | CDL-042 / Phase-694-700 Track A / SEC-001 | Agent sender authorization envelope for ECU fast-path transfers | open | leave sender authorization outside constitutional law, open a narrow sender-authorization lane for fast-path transfers, broaden into generalized transfer-auth redesign | open a narrow sender-authorization lane for fast-path transfers | docs/specs/ilc_phase_694_700_sequence_lock_v0.1.md, docs/specs/ilc_cdl_066_agent_sender_authorization_opening_stub_694_v0.1.md, docs/research/ilc_mysticeti_implementation_lane_m_series_v0.1.md |
