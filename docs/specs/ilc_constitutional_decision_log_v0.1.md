...
| CDL-058 | Phase-512 / Phase-517 / CDL-055 / CDL-046 | Validator re_admission boundary for bounded cooldown-based re-entry after liveness failure, equivocation slash, or voluntary exit | open | leave validator re_admission boundary outside constitutional law, cooldown period per exit-reason type, reputation-floor or sponsor-based re-entry gates | cooldown period per exit-reason type in issuance epochs | docs/specs/ilc_phase_515_524_sequence_lock_v0.1.md, docs/specs/ilc_cdl_058_re_admission_boundary_scoping_512_v0.1.md, docs/specs/ilc_sim_011_re_admission_boundary_calibration_517_v0.1.md, docs/specs/ilc_cdl_058_re_admission_boundary_opening_stub_518_v0.1.md |
