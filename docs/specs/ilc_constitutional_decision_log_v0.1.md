...
| CDL-046 | CDL-035 / SIM-007 / Phase-402 Sequence Lock 402 v0.1 | timed_out validation-state amendment for churn and orphan recovery semantics | open | retain CDL-035 bounded lifecycle without timed_out amendment, open dedicated amendment row with bounded timeout-and-recovery prelock, open dedicated amendment row with fixed timeout and recovery constants prelock | open dedicated amendment row with fixed timeout and recovery constants prelock (proposed) | SIM-007 timeout and recovery calibration anchor, issuance-epoch interpretation lock, CDL-035 bounded lifecycle attachment clause |
