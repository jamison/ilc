...
| CDL-032 | ADM-002 | CLI-first Agent SDK interface contract and command surface | ratified | single CLI entry point, split library + CLI, API-first | CLI-first | ADM-002 ratification artifact, command surface spec, I/O contract schema | ratified_phase: 253 | ratified_date: 2026-02-21 | evidence_document: docs/specs/ilc_cdl_032_cli_first_sdk_ratification_evidence_253_v0.1.md |
