...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| `openclaw_skill_local` | `pass` | 107 | 1124334 | 30255 | `False` | `False` | `False` |
| `openclaw_skill_claimable` | `pass` | 110 | 1148530 | 30925 | `False` | `True` | `False` |
...
| `openclaw_skill_local` | `local_sidecar` | `measurement_only` | 11 | 342227 | 8634 |
...
| `openclaw_skill_claimable` | `local_sidecar` | `measurement_only` | 11 | 342227 | 8634 |
