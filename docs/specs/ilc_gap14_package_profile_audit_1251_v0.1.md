...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| `openclaw_skill_local` | `pass` | 108 | 1188525 | 31890 | `False` | `False` | `False` |
| `openclaw_skill_claimable` | `pass` | 111 | 1212721 | 32560 | `False` | `True` | `False` |
...
| `openclaw_skill_local` | `local_sidecar` | `measurement_only` | 12 | 406418 | 10269 |
...
| `openclaw_skill_claimable` | `local_sidecar` | `measurement_only` | 12 | 406418 | 10269 |
