...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| `openclaw_skill_local` | `pass` | 93 | 641604 | 18410 | `False` | `False` | `False` |
| `openclaw_skill_claimable` | `pass` | 96 | 665800 | 19080 | `False` | `True` | `False` |
...
| `openclaw_skill_local` | `ilc_harness_adapters` | `pass` | 7 | 96041 | 2530 |
...
| `openclaw_skill_claimable` | `ilc_harness_adapters` | `pass` | 7 | 96041 | 2530 |
...
- `phase_1252`: `RCGAP-1250-FIX1-002`, `RCGAP-1250-FIX1-003`; status `carried_forward`; token `phase_1252_digest_truncation_security_binding_classification_recorded`
...
- `phase_1254`: `RCGAP-1250-FIX1-006`; status `carried_forward`; token `phase_1254_legacy_graph_delta_gap_disposition_recorded`
