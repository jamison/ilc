...
| --- | --- | ---: | ---: | ---: | --- | --- | --- |
| `openclaw_skill_local` | `pass` | 108 | 1189619 | 31910 | `False` | `False` | `False` |
| `openclaw_skill_claimable` | `pass` | 111 | 1213815 | 32580 | `False` | `True` | `False` |
...
| `openclaw_skill_local` | `local_sidecar` | `measurement_only` | 12 | 407512 | 10289 |
...
| `openclaw_skill_claimable` | `local_sidecar` | `measurement_only` | 12 | 407512 | 10289 |
