...
**Expected bucket_key_b64u (head 0):**

| 2-gram | bucket_key_b64u |
|--------|----------------|
| `hello\x1fworld` | `HJa6H7nn6qk` |
| `world\x1ftest` | `sMfke74adZo` |

> [!NOTE]
> Values generated by `python3 tools/ngram_route_index_test_vectors.py`.
...
| 2-gram | bucket_key_b64u |
|--------|----------------|
| `multiple\x1fspaces` | `dD6R9C-F-20` |
| `spaces\x1fhere` | `26YEXyLuwRo` |
...
| 2-gram | bucket_key_b64u |
|--------|----------------|
| `mixed\x1fcase` | `b5dh6DvrBoU` |
| `case\x1ftext` | `Pu772CIvePw` |
