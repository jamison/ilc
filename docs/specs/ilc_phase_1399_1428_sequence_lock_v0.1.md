...
**Status:** Active sequence lock — Window 1399-1428 is OPEN; Phase 1406 CDL-093 opening complete, Phase 1407 next
**Date:** 2026-05-20
...
committed as `PENDING_C1`; CDL register opening C2 committed as `PENDING_C2`.
