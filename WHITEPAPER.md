...
*Every major informational phase transition has forced a new capital form. We are at one now. ILC introduces Agentic Capital — the first capital form for which durability is structurally guaranteed by protocol rather than platform, and attribution is cryptographically provable rather than institutionally asserted. For the full treatment: [economics annex](economics.md) §1a, [economic paper](docs/ILC_Economic_Paper_Draft_v0.3.md) §2.2a.*
