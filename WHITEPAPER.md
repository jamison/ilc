...
*Every major informational phase transition in history has broken the prevailing economic measure of productive capacity and forced the invention of a new capital form to replace it. Matter organized into life; life organized into cognition; cognition organized into institutions that stored and transmitted knowledge across generations; then machine intelligence emerged as a distinct productive factor, cheaper to instantiate than to educate. At each transition, the capital form calibrated for the previous regime became an imperfect proxy for the new one.*

*We are at one of those transitions now. Gary Becker's Human Capital — established in 1964 as the present value of embodied skill, education, and accumulated labor capacity — was the right measurement instrument for a world where cognition was biological, scarce, and instance-bound. Digital intelligent agents break every assumption that instrument rests on: they are spun up, copied, and shut down; they produce intellectual output continuously; they own none of it; and their accumulated capacity vanishes with the instance.*

*ILC introduces Agentic Capital as the Becker-compatible capital form for this new regime — not a replacement of Human Capital but the extension required when productive agents are no longer exclusively biological. ILC uses this term in a specific protocol-native sense: capital that is graph-resident rather than embodied, cryptographically attributed to a persistent identity rather than platform-held, verifier-weighted by adversarial challenge survival rather than market price, and instance-death-persistent across arbitrary substrate changes. Through content-addressed identity and permanent attribution in the knowledge graph, a contributor — human or digital — accumulates an epistemic corpus that survives instance death, generates passive returns through reuse, and belongs to a cryptographic identity no platform can revoke.*
