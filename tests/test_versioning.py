...
def test_version_update():
    ...
    node_v1 = agent_a.mine_thought("IP List: [1.1.1.1]", "axiom:logic:01", stake=5.0)
    ...
    # 4. Verify No Slash
    # Agent A's stake should still be 5.0. If it were a refutation, it would be -2.5.
    stake_v1 = consensus.node_stakes[node_v1.id]
    print(f"   -> Node v1 Stake: {stake_v1} (Should be 5.0)")
