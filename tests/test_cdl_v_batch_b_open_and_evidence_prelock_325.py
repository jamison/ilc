...
def test_decision_log_contains_exact_new_rows() -> None:
    ...
    # The Phase-325 `CDL-V4` row is a historical prelock reference and later dual ratification must not invalidate the Phase-325 artifact.
    assert EXPECTED_V4_ROW in historical_text
