...
def make_commit_epoch_payload(
    ...
    reward_total: Decimal | str = Decimal("100"),
    stake_total: Decimal | str = Decimal("1000"),
    task_count: int = 10,
    agent_count: int = 2,
) -> dict:
...
class TestInMemoryLedgerBackend:
    ...
    def test_rolled_back_marks_epoch_no_balance_change(self):
        ...
        # No balance changes
        assert ledger.get_balance("any_agent") == Decimal("0")
    ...
    def test_superseded_updates_prior_and_marks_new(self):
        ...
        payload2 = make_commit_epoch_payload(
            ...
            epoch_index=60,
            finalization_state="committed",
            reward_total=Decimal("90"),  # Corrected amount
        )
    ...
    def test_balances_unchanged_with_stub_rule(self):
        ...
        assert ledger.get_balance("agent_1") == Decimal("0")
        assert ledger.get_balance("agent_2") == Decimal("0")
    ...
    def test_store_and_retrieve_stake_snapshot(self):
        ...
        snapshot = StakeSnapshot(
            ...
            stakes={"agent_a": Decimal("600"), "agent_b": Decimal("400")},
    ...
    def test_apply_rewards_with_snapshot(self):
        ...
        assert ledger.get_balance("agent_a") == Decimal("60")
        assert ledger.get_balance("agent_b") == Decimal("40")
    ...
    def test_apply_rewards_missing_snapshot_stub(self):
        ...
        # Balances unchanged
        assert ledger.get_balance("agent_a") == Decimal("0")
    ...
    def test_superseded_reverses_distribution(self):
        ...
        payload2 = make_commit_epoch_payload(
            epoch_id="epoch_20_v2", epoch_index=20, reward_total=Decimal("80")
        )
        ...
        # Reverse V1: -50.0 -> 0.0
        # Apply V2: +80.0 -> 80.0
        assert ledger.get_balance("agent_a") == Decimal("80")
