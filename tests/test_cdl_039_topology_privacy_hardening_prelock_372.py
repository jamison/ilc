...
def test_phase_372_cdl039_row_is_historical_open_reference() -> None:
    # The Phase-372 `CDL-039` row is a historical prelock reference.
    rows = parse_decision_register_rows(_decision_log_text_at_ref(_resolve_phase_372_commit_ref_or_fail()))
    row = rows["CDL-039"]
