...
def test_handoff_artifact_exists_with_required_headings_and_tokens() -> None:
    ...
    for token in (
        ...
        assert token in text
    # HISTORICAL_SNAPSHOT: the handoff records the Phase 562 state. Current
    # runtime advanced to Phase 1572 after signed-envelope hardening.
    assert 'gossip_transport_runtime_558.v0.1' in text
    assert 'gossip_transport_runtime_1572.v0.1' in Path(
