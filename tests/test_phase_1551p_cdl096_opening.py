...
def test_cdl_register_has_open_cdl096_without_ratification_or_activation() -> None:
...
def test_sequence_lock_frontier_advances_to_phase_1552() -> None:
...
def test_frontier_docs_record_open_not_ratified_boundary() -> None:
    ...
    assert "CDL-096 is open but not ratified" in combined
