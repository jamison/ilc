...
EPOCH_SEQ_BINCODE_LEN = 8
CIDV1_ROOT_BINCODE_LEN = 36
PROPOSAL_COMMITMENT_SHA256_LEN = 32
SPECTRAL_HASH_SHA256_LEN = 32
NOT_BEFORE_UNIX_MS_BINCODE_LEN = 8
STORED_CHECKPOINT_RECORD_LEN = (
    EPOCH_SEQ_BINCODE_LEN
    + CIDV1_ROOT_BINCODE_LEN
    + SPECTRAL_HASH_SHA256_LEN
    + PROPOSAL_COMMITMENT_SHA256_LEN
    + NOT_BEFORE_UNIX_MS_BINCODE_LEN
)
